    ...
    return (
        <>
            ...
            <div className='policy-container'>
                ...
                <h2 className="wp-block-heading">Einleitung</h2>
                ...
                <h2 className="wp-block-heading">Inhaltsübersicht</h2>



                <ul><li><a href="#m14">Einleitung</a></li><li><a href="#m3">Verantwortlicher</a></li><li><a href="#mOverview">Übersicht der Verarbeitungen</a></li><li><a href="#m13">Maßgebliche Rechtsgrundlagen</a></li><li><a href="#m27">Sicherheitsmaßnahmen</a></li><li><a href="#m25">Übermittlung und Offenbarung von personenbezogenen Daten</a></li><li><a href="#m24">Datenverarbeitung in Drittländern</a></li><li><a href="#m134">Einsatz von Cookies</a></li><li><a href="#m317">Kommerzielle und geschäftliche Leistungen</a></li><li><a href="#m225">Bereitstellung des Onlineangebotes und Webhosting</a></li><li><a href="#m328">Plugins und eingebettete Funktionen sowie Inhalte</a></li><li><a href="#m12">Löschung von Daten</a></li><li><a href="#m15">Änderung und Aktualisierung der Datenschutzerklärung</a></li><li><a href="#m10">Rechte der betroffenen Personen</a></li><li><a href="#m42">Begriffsdefinitionen</a></li></ul>



                <h2 className="wp-block-heading" id="m3">Verantwortlicher</h2>
                ...
                <h2 className="wp-block-heading" id="mOverview">Übersicht der Verarbeitungen</h2>
                ...
                <h3 className="wp-block-heading">Arten der verarbeiteten Daten</h3>



                <ul><li>Bestandsdaten (z.B. Namen, Adressen).</li><li>Inhaltsdaten (z.B. Eingaben in Onlineformularen).</li><li>Kontaktdaten (z.B. E-Mail, Telefonnummern).</li><li>Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen).</li><li>Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten).</li><li>Standortdaten (Angaben zur geografischen Position eines Gerätes oder einer Person).</li><li>Vertragsdaten (z.B. Vertragsgegenstand, Laufzeit, Kundenkategorie).</li><li>Zahlungsdaten (z.B. Bankverbindungen, Rechnungen, Zahlungshistorie).</li></ul>



                <h3 className="wp-block-heading">Kategorien betroffener Personen</h3>



                <ul><li>Geschäfts- und Vertragspartner.</li><li>Interessenten.</li><li>Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li></ul>



                <h3 className="wp-block-heading">Zwecke der Verarbeitung</h3>



                <ul><li>Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit.</li><li>Büro- und Organisationsverfahren.</li><li>Kontaktanfragen und Kommunikation.</li><li>Erbringung vertragliche Leistungen und Kundenservice.</li><li>Verwaltung und Beantwortung von Anfragen.</li></ul>



                <h3 className="wp-block-heading" id="m13">Maßgebliche Rechtsgrundlagen</h3>
                ...
                <h2 className="wp-block-heading" id="m27">Sicherheitsmaßnahmen</h2>
                ...
                <h2 className="wp-block-heading" id="m25">Übermittlung und Offenbarung von personenbezogenen Daten</h2>
                ...
                <h2 className="wp-block-heading" id="m24">Datenverarbeitung in Drittländern</h2>
                ...
                <h2 className="wp-block-heading" id="m134">Einsatz von Cookies</h2>
                ...
                <h2 className="wp-block-heading" id="m317">Kommerzielle und geschäftliche Leistungen</h2>
                ...
                <h2 className="wp-block-heading" id="m225">Bereitstellung des Onlineangebotes und Webhosting</h2>
                ...
                <ul><li><strong>Verarbeitete Datenarten:</strong> Inhaltsdaten (z.B. Eingaben in Onlineformularen), Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen).</li><li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li><li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).</li></ul>



                <h2 className="wp-block-heading" id="m328">Plugins und eingebettete Funktionen sowie Inhalte</h2>
                ...
                <ul><li><strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z.B. besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B. Geräte-Informationen, IP-Adressen), Standortdaten (Angaben zur geografischen Position eines Gerätes oder einer Person).</li><li><strong>Betroffene Personen:</strong> Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten).</li><li><strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit, Erbringung vertragliche Leistungen und Kundenservice.</li><li><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO).</li></ul>
                ...
                <ul><li><strong>Font Awesome:</strong> Darstellung von Schriftarten und Symbolen; Dienstanbieter: Fonticons, Inc. ,6 Porter Road Apartment 3R, Cambridge, MA 02140, USA; Website: <a href="https://fontawesome.com/" target="_blank" rel="noreferrer noopener">https://fontawesome.com/</a>; Datenschutzerklärung: <a href="https://fontawesome.com/privacy" target="_blank" rel="noreferrer noopener">https://fontawesome.com/privacy</a>.</li><li><strong>Google Fonts:</strong> Wir binden die Schriftarten (&#8222;Google Fonts&#8220;) des Anbieters Google ein, wobei die Daten der Nutzer allein zu Zwecken der Darstellung der Schriftarten im Browser der Nutzer verwendet werden. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen an einer technisch sicheren, wartungsfreien und effizienten Nutzung von Schriftarten, deren einheitlicher Darstellung sowie unter Berücksichtigung möglicher lizenzrechtlicher Restriktionen für deren Einbindung. Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a href="https://fonts.google.com/" target="_blank" rel="noreferrer noopener">https://fonts.google.com/</a>; Datenschutzerklärung: <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer noopener">https://policies.google.com/privacy</a>.</li><li><strong>Google Maps:</strong> Wir binden die Landkarten des Dienstes “Google Maps” des Anbieters Google ein. Zu den verarbeiteten Daten können insbesondere IP-Adressen und Standortdaten der Nutzer gehören, die jedoch nicht ohne deren Einwilligung (im Regelfall im Rahmen der Einstellungen ihrer Mobilgeräte vollzogen), erhoben werden; Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a href="https://cloud.google.com/maps-platform" target="_blank" rel="noreferrer noopener">https://cloud.google.com/maps-platform</a>; Datenschutzerklärung: <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer noopener">https://policies.google.com/privacy</a>; Widerspruchsmöglichkeit (Opt-Out): Opt-Out-Plugin: <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noreferrer noopener">https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen: <a href="https://adssettings.google.com/authenticated" target="_blank" rel="noreferrer noopener">https://adssettings.google.com/authenticated</a>.</li><li><strong>OpenStreetMap:</strong> Wir binden die Landkarten des Dienstes &#8222;OpenStreetMap&#8220; ein, die auf Grundlage der Open Data Commons Open Database Lizenz (ODbL) durch die OpenStreetMap Foundation (OSMF) angeboten werden. Die Daten der Nutzer werden durch OpenStreetMap ausschließlich zu Zwecken der Darstellung der Kartenfunktionen und zur Zwischenspeicherung der gewählten Einstellungen verwendet. Zu diesen Daten können insbesondere IP-Adressen und Standortdaten der Nutzer gehören, die jedoch nicht ohne deren Einwilligung (im Regelfall im Rahmen der Einstellungen ihrer Mobilgeräte vollzogen) erhoben werden. Dienstanbieter: OpenStreetMap Foundation (OSMF); Website: <a href="https://www.openstreetmap.de" target="_blank" rel="noreferrer noopener">https://www.openstreetmap.de</a>; Datenschutzerklärung: <a href="https://wiki.openstreetmap.org/wiki/Privacy_Policy" target="_blank" rel="noreferrer noopener">https://wiki.openstreetmap.org/wiki/Privacy_Policy</a>.</li><li><strong>ReCaptcha:</strong> Wir binden die Funktion &#8222;ReCaptcha&#8220; zur Erkennung von Bots, z.B. bei Eingaben in Onlineformularen, ein. Die Verhaltensangaben der Nutzer (z.B. Mausbewegungen oder Abfragen) werden ausgewertet, um Menschen von Bots unterscheiden zu können. Dienstanbieter: Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA; Website: <a href="https://www.google.com/recaptcha/" target="_blank" rel="noreferrer noopener">https://www.google.com/recaptcha/</a>; Datenschutzerklärung: <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer noopener">https://policies.google.com/privacy</a>; Widerspruchsmöglichkeit (Opt-Out): Opt-Out-Plugin: <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank" rel="noreferrer noopener">https://tools.google.com/dlpage/gaoptout?hl=de</a>, Einstellungen für die Darstellung von Werbeeinblendungen: <a href="https://adssettings.google.com/authenticated" target="_blank" rel="noreferrer noopener">https://adssettings.google.com/authenticated</a>.</li><li><strong>Typekit-Schriftarten von Adobe:</strong> Wir binden die Schriftarten (&#8222;Typekit fonts&#8220;) des Anbieters Adobe ein, wobei die Daten der Nutzer allein zu Zwecken der Darstellung der Schriftarten im Browser der Nutzer verwendet werden. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen an einer technisch sicheren, wartungsfreien und effizienten Nutzung von Schriftarten, deren einheitlicher Darstellung sowie unter Berücksichtigung möglicher lizenzrechtlicher Restriktionen für deren Einbindung. Dienstanbieter: Adobe Systems Software Ireland Limited, 4-6 Riverwalk, Citywest Business Campus, Dublin 24, Irland; Website: <a href="https://www.adobe.com/de" target="_blank" rel="noreferrer noopener">https://www.adobe.com/de</a>; Datenschutzerklärung: <a href="https://www.adobe.com/de/privacy.html" target="_blank" rel="noreferrer noopener">https://www.adobe.com/de/privacy.html</a>.</li></ul>



                <h2 className="wp-block-heading" id="m12">Löschung von Daten</h2>
                ...
                <h2 className="wp-block-heading" id="m15">Änderung und Aktualisierung der Datenschutzerklärung</h2>
                ...
                <h2 className="wp-block-heading" id="m10">Rechte der betroffenen Personen</h2>
                ...
                <h2 className="wp-block-heading" id="m42">Begriffsdefinitionen</h2>
